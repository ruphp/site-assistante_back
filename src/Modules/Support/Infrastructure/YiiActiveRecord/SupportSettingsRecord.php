...
final class SupportSettingsRecord extends ActiveRecord
{
    ...
    public function rules(): array
    {
        return [
            [['public_key'], 'required'],
            [['public_key', 'enabled', 'polling_interval_seconds', 'keep_widget_open_when_online', 'auto_open_snooze_minutes', 'ask_name', 'ask_email', 'ask_phone', 'notify_email', 'notify_telegram', 'notify_max'], 'integer'],
