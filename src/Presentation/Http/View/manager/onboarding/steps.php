        ...
        <?php foreach ($steps as $step): ?>
            <article class="sw-instruction-card">
                ...
                <div class="sw-instruction-actions uk-margin-small-top">
                    <?= Html::a('Редактировать', ['/manager/onboarding/steps', 'sectionId' => $section->id, 'editId' => $step->id, 'projectId' => $activeProject->id], ['class' => 'uk-button uk-button-primary uk-button-small']) ?>
