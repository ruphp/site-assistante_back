...
$items = [
    [
        ...
        'settings' => [
            'public key проекта',
            'включение передачи id пользователя, имени, email и ролей, когда понадобится авторизация посетителя',
        ],
    ],
    [
        'id' => 'joomla',
        ...
        'settings' => [
            'public key проекта',
            'передача данных авторизованного пользователя и групп Joomla, когда это будет включено в настройках',
        ],
    ],
    [
        'id' => 'opencart',
        ...
        'settings' => [
            'public key проекта',
            'передача данных покупателя и групп клиентов, когда понадобится фильтрация контента по ролям',
        ],
    ],
];
?>
