...
$html = '<div class="uk-card uk-card-body uk-card-default stat_all">
    ...
    <label ><input name="open_widget_only_unic" class="uk-checkbox uk-margin-remove" type="checkbox"> Учитывать только уникальные</label>
    </div>
...
$html .= DatePicker::widget([
    'name'          => 'from_date_chart_open_widget',
    'value'         => $start_date,
    'language'      => 'ru',
    'type'          => DatePicker::TYPE_RANGE,
    'name2'         => 'to_date_chart_open_widget',
    'value2'        => $end_date,
...
$html .= "<div id='chart_open_widget'></div>";
$html .= '</div>
