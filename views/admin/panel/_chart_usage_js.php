...
/** @var $categories */
/** @var $series */
//\app\helpers\ManagerHelpers::debug($categories ,1);
?>
...
<script>*/
    ...
    let chart_usage_val_list_systems = 0;
    let chart_usage_list_systems = jQuery('#chart_usage_list_systems');
    if (chart_usage_list_systems.length > 0) {
        chart_usage_val_list_systems = chart_usage_list_systems ? chart_usage_list_systems.val() : 0;
    }



    jQuery.get('/admin/content_statistics/chart?name=usage&date_from=' + date_from_val_chart_usage + '&date_to=' + date_to_val_chart_usage + '&usage_only_unic=' + only_unic_val_chart_usage + '&type_period=' + chart_usage_group_period_val + '&system=' + chart_usage_val_list_systems, function (data) {
        setDateUsage(data);
    });
    ...
    date_from_chart_usage.on('change', () => {
        ...
        jQuery.get('/admin/statistics/chart?name=usage&date_from=' + date_from_val_chart_usage + '&date_to=' + date_to_val_chart_usage + '&usage_only_unic=' + only_unic_val_chart_usage + '&type_period=' + chart_usage_group_period_val + '&system=' + chart_usage_val_list_systems, function (data) {
            setDateUsage(data);
        });
    ...
    chart_usage_list_systems.on('change', () => {
        console.log(543543);

        chart_usage_val_list_systems = chart_usage_list_systems[0].value;
