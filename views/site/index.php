...
$this->title = 'Центр интерактивной поддержки пользователей';
$this->registerMetaTag([
    'name'    => 'description',
    'content' => 'Контекстная поддержка пользователей на Вашем web-ресурсе: онлайн-помощник (HELP CENTER), интерактивные подсказки (HIGHLIGHTS), система дистанционного обучения (SMARTIUS LMS)',
]);
$this->registerMetaTag([
    'name'    => 'keywords',
    'content' => 'онлайн помощник,help center,live chat,онлайн подсказки,highlights,поддержка пользователей,система дистанционного обучения,сдо,lms,learning management system,faq,чаво,smartius guide,smartius lms,smartius,parma technologies group',
]);
?>
<div class="uk-section  uk-section-default">
    <div class="uk-container">

        <p class="uk-text-center  big-text uk-margin-remove">SMARTIUS GUIDE</p>
    ...
    <div class="uk-container">
        ...
        <div id="new-form" class="uk-margin-auto uk-width-1-2 ">
            ...
            <p class="uk-text-center">
                ...
                <?= $form->field($model, 'code')->widget(RecaptchaV3Widget::className()); ?>
